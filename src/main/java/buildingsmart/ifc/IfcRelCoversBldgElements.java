...
public class IfcRelCoversBldgElements extends IfcRelConnects {
    ...
    private IfcCovering[] RelatedCoverings;
     ...
     */
    public IfcRelCoversBldgElements(IfcGloballyUniqueId globalId,
     ...
     */
    public IfcRelCoversBldgElements(IfcOwnerHistory ownerHistory, IfcLabel name,
                                    IfcText description) {
