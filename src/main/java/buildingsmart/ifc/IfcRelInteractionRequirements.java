...
public class IfcRelInteractionRequirements extends IfcRelConnects {
    private final double DailyInteraction;
    private IfcRatioMeasure ImportanceRating;
     ...
     */
    public IfcRelInteractionRequirements(IfcGloballyUniqueId globalId,
                                         IfcOwnerHistory ownerHistory,
                                         IfcLabel name, IfcText description,
                                         double dailyInteraction) {
