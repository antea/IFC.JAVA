...
public abstract class IfcTerminatorSymbol
    ...
    public IfcTerminatorSymbol(IfcRepresentationItem item, Set<IfcPresentationStyleAssignment> styles,
                               IfcLabel name, IfcAnnotationCurveOccurrence annotatedCurve) {
