...
public class IfcActor extends IfcObject {
    private final IfcActorSelect TheActor;
    private IfcRelAssignsToActor[] IsActingUpon;
     ...
     *                                  of this class.
     */
    public IfcActor(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory,
