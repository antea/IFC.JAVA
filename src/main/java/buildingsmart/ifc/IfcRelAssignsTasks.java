...
public class IfcRelAssignsTasks extends IfcRelAssignsToControl {
    private final IfcScheduleTimeControl TimeForTask;
     ...
     */
    public IfcRelAssignsTasks(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
                              IfcText description, IfcScheduleTimeControl timeForTask) {
