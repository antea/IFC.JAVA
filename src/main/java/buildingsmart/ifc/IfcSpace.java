...
public class IfcSpace extends IfcSpatialStructureElement {
    private final IfcInternalOrExternalEnum InteriorOrExteriorSpace;
     ...
     *                       for
     *                        informal purposes. Maybe used in conjunction
     *                        with the
     ...
     *                        (complex)
     *                        or a part (part). The interpretation is given
     *                        separately for each subtype of spatial structure
     *                        element.
     ...
     */
    public IfcSpace(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory,
