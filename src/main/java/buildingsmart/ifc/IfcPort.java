...
public class IfcPort extends IfcProduct {
     ...
     *                                  of this class.
     */
    public IfcPort(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory,
     ...
     */
    public IfcPort(IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description, IfcLabel objectType) {
