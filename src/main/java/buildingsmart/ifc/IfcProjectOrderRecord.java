...
public class IfcProjectOrderRecord extends IfcControl {
    private final IfcRelAssignsToProjectOrder[] Records;
     ...
     *                                  of this class.
     */
    public IfcProjectOrderRecord(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
                                 IfcText description, IfcLabel objectType,
                                 IfcRelAssignsToProjectOrder[] records) {
