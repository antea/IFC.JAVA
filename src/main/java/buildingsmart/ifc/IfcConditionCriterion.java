...
public class IfcConditionCriterion extends IfcControl {
    private final IfcConditionCriterionSelect Criterion;
     ...
     *                                  of this class.
     */
    public IfcConditionCriterion(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
