...
/**
 * <p>
 * The distribution flow element <i>IfcFlowStorageDevice</i> defines the
 * occurrence of a device that participates in a distribution system and is used
 * for temporary storage of a fluid such as a liquid or a gas (e.g., tank). Its
 * type is defined by
 * <i>IfcFlowStorageDeviceType</i> or
 * its subtypes.</p>
 ...
 * relationship. The following property set definitions specific to this entity
 ...
 *        <li><a href="../../psd/IfcSharedBldgServiceElements/Pset_FlowStorageDeviceTank.xml"
 *          target="SOURCE">Pset_FlowStorageDeviceTank</a>: property set for
 *          tank storage device
 * occurrences
 *        </li>
 *     </ul>
 ...
 * 	<p>The geometric representation of <i>IfcFlowStorageDevice</i> is given
...
public class IfcFlowStorageDevice extends IfcDistributionFlowElement {
    /**
     * Creates a new IfcFlowStorageDevice, using the provided globalId.
     *
     ...
     */
    @Builder(builderMethodName = "flowStorageDeviceBuilder")
    public IfcFlowStorageDevice(@NonNull IfcGloballyUniqueId globalId,
