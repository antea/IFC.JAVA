...
public class IfcDistributionChamberElement extends IfcDistributionFlowElement {
     ...
     * @throws IllegalArgumentException If globalId was used in another
     * instance of
     *                                  this class; if representation is not
     *                                  null
     *                                  and objectPlacement is, while
     *                                  representation
     *                                  is an instance of IfcProductDefinitionShape.
     */
    public IfcDistributionChamberElement(@NonNull IfcGloballyUniqueId globalId,
